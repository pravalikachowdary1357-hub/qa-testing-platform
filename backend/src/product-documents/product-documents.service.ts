    ...
    return [
      {
        ...
        relatedVersion: document.relatedVersion,
      ...
      ...versions.map((v) => ({
        ...
        relatedVersion: v.relatedVersion,
        status: v.status,
    ...
    try {
      created = await this.prisma.productDocument.create({
        data: {
          ...
          relatedVersion: dto.relatedVersion,
    ...
    const [, updated] = await this.prisma.$transaction([
      this.prisma.productDocumentVersion.create({
        data: {
          ...
          relatedVersion: existing.relatedVersion,
      ...
      this.prisma.productDocument.update({
        ...
        data: {
          ...
          relatedVersion: dto.relatedVersion ?? existing.relatedVersion,
